...
## ----eval = F------------------------------------------------------------------------------------
saveRDS(coef_matrix, file = "baseline_coef_CI-fix_1k.rds")
saveRDS(nonzero_matrix, file = "baseline_nonzero_CI-fix_1k.rds")
 


## ----eval = T------------------------------------------------------------------------------------
# coef_matrix <- readRDS(file = "baseline_coef_CI-fix_1k.rds")
# nonzero_matrix <- readRDS(file = "baseline_nonzero_CI-fix_1k.rds")
...
## ----eval = F------------------------------------------------------------------------------------
saveRDS(coef_matrix, file = "moderators_coef_CI-fix_1k.rds")
saveRDS(nonzero_matrix, file = "moderators_nonzero_CI-fix_1k.rds")
 


## ----eval = T------------------------------------------------------------------------------------
# coef_matrix <- readRDS(file = "moderators_coef_CI-fix_1k.rds")
# nonzero_matrix <- readRDS(file = "moderators_nonzero_CI-fix_1k.rds")
