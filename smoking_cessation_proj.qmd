...
```{r, fig.height=2.4, fig.width=6.5, fig.cap="Relationship between FTCD Score and Estimates"}
...
```{r, fig.cap="Relationship between Hedonsum Score and Estimates", eval=F}
